...
namespace Clients.WebClient.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Connect(string access_token)
        {
            ...
            //Aca se queda con el codigo del medio del token, que si lo convertís en una pagina llamada
            //base64decode.org te das cuenta que es la información del usuario
            //var base64Content = Convert.FromBase64String(token[1]);
            var base64Content = WebEncoders.Base64UrlDecode(token[1]);
